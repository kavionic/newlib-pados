...
#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER     _PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP
#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP  _PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP
#define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER    _PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP
#define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP _PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP
...
int   pthread_cond_clockwait(pthread_cond_t* cond, pthread_mutex_t* mutex, clockid_t, const struct timespec*);
